    ...
    */
    ...
    always @(posedge clk) begin
        ...
        begin
            ...
            Config[6:3]     <= 4'b0;
            Config[2:0]     <= 3'h2;//K0,3 -> cache, others -> uncache
        end
    ...
    always @(posedge clk) begin
        ...
        begin
            ...
            Config1[30:25]  <= 6'h15;
            Config1[24:22]  <= 3'h0;
            Config1[21:19]  <= 3'h5;//0 -- > no icache, 5 -- > a cache block = 16 words
            Config1[18:16]  <= 3'h1;
            Config1[15:13]  <= 3'h0;
            Config1[12:10]  <= 3'h0;//0 -- > no dcache, 5 -- > a cache block = 16 words
            Config1[9:7]    <= 3'h1;
