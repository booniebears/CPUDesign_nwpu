...
#
# Generated by export_simulation on Tue Aug 02 11:00:37 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './complex_ila.sh' script.

./complex_ila.sh -reset_run
...
./complex_ila.sh -noclean_files

For more information on the script, please type './complex_ila.sh -help'.
