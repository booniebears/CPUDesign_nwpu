...
HD_PWD='E:/study/game/code/test/display/soc_up/vivado_xpr/project_1/project_1/project_1.runs/complex_ila_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log complex_ila.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source complex_ila.tcl
