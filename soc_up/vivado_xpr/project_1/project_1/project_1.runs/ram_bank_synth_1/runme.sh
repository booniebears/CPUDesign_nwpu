...
HD_PWD='E:/study/game/code/test/display/soc_up/vivado_xpr/project_1/project_1/project_1.runs/ram_bank_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_bank.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_bank.tcl
