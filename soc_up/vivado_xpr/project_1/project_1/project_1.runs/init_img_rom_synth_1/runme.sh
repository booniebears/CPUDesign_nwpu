...
HD_PWD='E:/study/game/code/test/display/soc_up/vivado_xpr/project_1/project_1/project_1.runs/init_img_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log init_img_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source init_img_rom.tcl
