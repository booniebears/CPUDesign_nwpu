...
set genomeRtd $env(RT_TMP)/2A6D32FE180.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {dma_master}]"
...
set genomeName [subst -nocommands -novariables {dma_master}]
