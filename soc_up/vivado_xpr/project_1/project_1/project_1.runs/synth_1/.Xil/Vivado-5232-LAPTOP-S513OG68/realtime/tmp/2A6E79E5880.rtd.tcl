...
set genomeRtd $env(RT_TMP)/2A6E79E5880.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {soc_up_top__GCB1}]"
...
set genomeName [subst -nocommands -novariables {soc_up_top__GCB1}]
