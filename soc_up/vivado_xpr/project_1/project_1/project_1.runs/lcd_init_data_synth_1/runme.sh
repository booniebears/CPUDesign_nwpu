...
HD_PWD='E:/study/game/code/test/display/soc_up/vivado_xpr/project_1/project_1/project_1.runs/lcd_init_data_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lcd_init_data.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lcd_init_data.tcl
