...
HD_PWD='E:/study/game/code/test/display/soc_up/vivado_xpr/project_1/project_1/project_1.runs/mydiv_unsigned_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mydiv_unsigned.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mydiv_unsigned.tcl
