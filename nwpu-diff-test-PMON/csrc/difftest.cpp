...
int difftest_rtl_nemu(rtlreg_t* reg_sv,int emu_pc,int emu_instr,int emu_store_len,int emu_store_data,int emu_store_vaddr,int emu_wdata,int emu_wnum)
{
    ...
    // keep pace with emu
    while (nemu_steps_cnt < RETIRE_QUEUE_MAX)
    {
        ref_napi_exec(1);
        ninstr++;
        ...
        // std::cout << std::endl;
        // std::cout << "[difftest] nemu_pc" << nemu_pc          << std::endl;
        // std::cout << "[difftest] nemu_instr" << nemu_instr       << std::endl;
        // std::cout << "[difftest] nemu_store_data" << nemu_store_data  << std::endl;
        // std::cout << "[difftest] nemu_store_vaddr" << nemu_store_vaddr << std::endl;
        // std::cout << "[difftest] nemu_store_len" << nemu_store_len   << std::endl;  
        // getchar(); 
        // if (nemu_store_len !=0)
        //     printf("nemu_store_data:0x%08x , nemu_store_vaddr:0x%08x ,nemu_store_len:%x\n ",
        //         nemu_store_data,nemu_store_vaddr,nemu_store_len);
        // std::cout << std::hex << "[difftest] nemu_pc" << nemu_pc          << std::endl;
        // std::cout << std::hex << "[difftest] emu_pc " << emu_pc          << std::endl;
        // getchar(); 
    ...
    // std::cout << "nemu_rtl_find is " << nemu_rtl_find << std::endl;
    // std::cout << "nemu_store_len is " << nemu_store_len << std::endl;
    // std::cout << "emu_store_len is " << emu_store_len << std::endl;
    // std::cout << "nemu_store_data is " << nemu_store_data << std::endl;
    // std::cout << /*std::hex <<*/ "emu_store_data is " << emu_store_data << std::endl;
    // std::cout << /*std::hex <<*/ "emu_store_data is " << emu_store_data << std::endl;
    // std::cout << /*std::hex <<*/ "nemu_store_vaddr is " << nemu_store_vaddr << std::endl;
    // std::cout << /*std::hex <<*/ "emu_store_vaddr is " << emu_store_vaddr << std::endl;    
