...
//480100ns 9fc00890 执行出错 原因应该是之前一条store指令失败
...
9fc00068:	03200008 	jr	t9 //9fc0038c
...
9fc0038c <run_test>:
run_test():
9fc0038c:	0411000c 	bal	9fc003c0 <shell9> //9fc003c0
...
9fc006f4:	00569023 	subu	s2,v0,s6 //得到Total Count(SoC count),gs132为0x57a08
9fc006f8:	12200027 	beqz	s1,9fc00798 <shell9+0x3d8> //error:未跳转?
9fc006fc:	02958023 	subu	s0,s4,s5 //得到Total Count(CPU count),gs132为0x27cca
...
9fc007ec:	00008821 	move	s1,zero  //这个归零在整个程序中只执行一次
9fc007f0:	00003021 	move	a2,zero  //这个归零在整个程序中只执行一次
...
9fc00818:	24c60004 	addiu	a2,a2,4 //这里执行出错???
...
9fc0090c:	26220001 	addiu	v0,s1,1 //所以这里s1应该已经是0了
...
9fc00a60:	aced0010 	sw	t5,16(a3) //这里和报错的地方相关,但是存数似乎没有问题
...
/media/sf_nscscc2019/final_develp/perftgt_putchar_test_final/soft/perf_func/lib/putchar.c:18
